...
namespace SimpleSongsPlayer.Views.SideViews
{
    /// <summary>
    /// 可用于自身或导航至 Frame 内部的空白页。
    /// </summary>
    [SideViewName("AboutPage")]
    public sealed partial class AboutPage : Page
    {
        ...
        {
            LoggerMembers.PagesLogger.Info("点击按钮 GitHub");
        ...
        {
            LoggerMembers.PagesLogger.Info("点击按钮 查看日志");
        ...
        {
            LoggerMembers.PagesLogger.Info("点击按钮 评论");
